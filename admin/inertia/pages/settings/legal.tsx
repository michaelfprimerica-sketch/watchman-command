...
export default function LegalPage() {
  return (
    <SettingsLayout>
      <Head title="Legal Notices | Watchman Command" />
        ...
        <main className="px-12 py-6 max-w-4xl">
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-4">
              Watchman Command integrates the following open source projects. We are grateful to
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Watchman Command is designed with privacy as a core principle:
            </p>
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Watchman Command provides tools to download and access content from third-party sources
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              Some content available through Watchman Command includes medical references, first aid guides,
          ...
          <section className="mb-10">
            ...
            <p className="text-text-primary mb-3">
              All data associated with Watchman Command is stored locally on your device:
            </p>
            <ul className="list-disc list-inside space-y-2 text-text-primary">
            ...
            <p className="text-text-primary mt-3">
              You maintain full control over your data. Uninstalling Watchman Command or deleting these
